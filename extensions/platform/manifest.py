...
EXTENSIONS = [
    ...
    Extension('deepseek', 'model_adapter', '1.0.0', Empty, ModelResponse,
        ...
        sources=('tools/platform_models.py', 'tools/deepseek_adapter.py'), capabilities=dict(real_requests=True, text=True, images=False, timeout='network request deadline', cancellation='between requests')),

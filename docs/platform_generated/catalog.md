...
| analysis.versioned_value | tool | 1.0.0 | True | Independent offline development example; no physical calibration |
| analysis.versioned_value | tool | 2.0.0 | True | Independent offline development example; no physical calibration |
| backend.genesis | backend | 1.0.0 | False | 待实现：必须检查目标版本并完成模型、信号与执行通道适配 |
| backend.limited_synthetic | backend | 1.0.0 | True | Independent offline development example; no physical calibration |
...
| candidate.controller | candidate_builder | 1.0.0 | True | Apply existing typed controller parameters |
| candidate.synthetic | candidate_builder | 1.0.0 | True | Independent offline development example; no physical calibration |
...
| deepseek | model_adapter | 1.0.0 | True | Existing text/tool model service transport |
...
| evaluate.terminal | evaluator | 1.0.0 | True | Independent offline development example; no physical calibration |
...
| model.observing | model_adapter | 1.0.0 | True | Independent offline development example; no physical calibration |
| offline | model_adapter | 1.0.0 | True | Offline scripted compatibility fixture |
| search.scalar_sequence | search | 1.0.0 | True | 确定性候选序列参考搜索器；算法拥有状态 |
| search.stateful | search | 1.0.0 | True | Independent offline development example; no physical calibration |
...
| strategy.evidence | strategy | 1.0.0 | True | Independent offline development example; no physical calibration |
| strategy.tool | strategy | 1.0.0 | True | One typed tool request per decision |
| task.reach | task | 1.0.0 | True | 已有到达语义的开发任务 |
| task.signal_hold | task | 1.0.0 | True | 离散长度信号保持开发示例；无末端目标点 |
| task.terminal | task | 1.0.0 | True | Independent offline development example; no physical calibration |
...
| worker.inventory | worker | 1.0.0 | True | Independent offline development example; no physical calibration |
| worker.math | worker | 1.0.0 | True | Independent offline development example; no physical calibration |
| worker.signal | worker | 2.0.0 | True | 读取同一固定证据的确定性本地工作者 |
